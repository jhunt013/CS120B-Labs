/*
 * jhunt013_myee005_lab10_part4.c
 *
...
//enum Freq_State{Freq_start, Freq_inc, Freq_inc_press, Freq_dec, Freq_dec_press}Freq_state;
enum Freq_states{Freq_start, Freq_releaseB2, Freq_releaseB3, Freq_on} Freq_state;
...
double sound[8] = {261.63, 293.66, 329.63, 349.63, 392.00, 440.00, 493.88, 523.25};
...
int main(void)
{
	...
	unsigned long Freq_elapsed_time = 0;
